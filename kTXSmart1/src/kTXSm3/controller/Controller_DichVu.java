...
public class Controller_DichVu extends DichVu implements ZEController, ServletRequestAware, ServletResponseAware{
	ObjectDAO dao = new DAO_DichVu();
	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "kTXSm3/pages/dichvus.jsp";
	String duongDanTrangView = "kTXSm3/pages/dichvu.jsp";
	...
	public String viewDetail() {
		...
		ArrayList<DichVu> arr = dao.listByColumnLike(tenCotTimDoiTuong, maobj);
		if (arr.size() > 0) {
	...
	public String saveOrUpdate() {
		...
		obj.maDichVu= getMaDichVu();
		obj.tenDichVu= getTenDichVu();
	...
	public String search() {
		...
		ArrayList<DichVu> arr = dao.listByColumnLike(column, key);
