...
public class Controller_NhaCungCap extends NhaCungCap implements ZEController {
	ObjectDAO dao = new DAO_NhaCungCap();
	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "kTXSm2/pages/nhacungcaps.jsp";
	String duongDanTrangView = "kTXSm2/pages/nhacungcap.jsp";
	String tenCotTimDoiTuong = "maNhaCungCap";
	String maObj;
	...
	public String viewDetail() {
		...
		ArrayList<NhaCungCap> arr = dao.listByColumnLike(tenCotTimDoiTuong, maobj);
		if (arr.size() > 0) {
	...
	public String saveOrUpdate() {
		...
		obj.maNhaCungCap = getMaNhaCungCap();
		obj.tenNhaCungCap= getTenNhaCungCap();
		obj.diaChi=getDiaChi();
		obj.soDienThoai=getSoDienThoai();
		obj.fax=getFax();
		obj.email=getEmail();
		obj.quocGia=getQuocGia();
	...
	public String search() {
		...
		ArrayList<NhaCungCap> arr = dao.listByColumnLike(column, key);
