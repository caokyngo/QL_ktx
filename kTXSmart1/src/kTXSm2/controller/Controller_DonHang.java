...
import kTXCore.modelDao.DAO_ChucNang;
...
public class Controller_DonHang extends DonHang implements ZEController {
	...
	public TinhTrangDonHang getTinhTrangDonHang() {
		...
		ArrayList<TinhTrangDonHang> ls_tinhtrangdonhang=dao_tinhtrangdonhang.listByColumns("maTinhTrangDonHang", getMaTinhTrangDonHang());
	...
	public LoaiDonHang getLoaiDonHang() {
		...
		ArrayList<LoaiDonHang> ls_loaidonhang=dao_loaidonhang.listByColumns("maLoai", getMaLoai());
		if(ls_loaidonhang.size()>0)
			return ls_loaidonhang.get(0);
		else
			return null;
	}
