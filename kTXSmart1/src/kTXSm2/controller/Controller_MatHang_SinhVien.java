...
import kTXSm2.model.MatHang_NhanVien;
import kTXSm2.model.MatHang_SinhVien;
import kTXSm2.model.NhaCungCap;
import kTXSm2.modelDao.DAO_KhuyenMai;
import kTXSm2.modelDao.DAO_MatHang;
import kTXSm2.modelDao.DAO_MatHang_SinhVien;
import kTXSm2.modelDao.DAO_NhaCungCap;
import kTXSm3.model.DichVu;
import kTXSm3.modelDao.DAO_DichVu;

public class Controller_MatHang_SinhVien extends MatHang implements ZEController {
	ObjectDAO dao = new DAO_MatHang_SinhVien();

	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "kTXSm2/pages/mathang_sinhviens.jsp";
	String duongDanTrangView = "kTXSm2/pages/mathang_sinhvien.jsp";
	...
	public String delete() {
		...
		HttpSession session = request.getSession();
		String maobj = request.getParameter("maobj");
		MatHang_SinhVien obj = new MatHang_SinhVien();
		//obj.setMaMatHang(maobj);
