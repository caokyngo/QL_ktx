...
import kTXCore.modelDanhMuc.DanToc;
import kTXCore.modelDanhMuc.TonGiao;
...
public class SinhVien implements Comparable<SinhVien> {
	...
	public SinhVien(String maSinhVien, String ten, String hoDem, String hoVaTen, String gioiTinh, String soCMND,
			...
			String soBaoDanh, String diemMon1, String diemMon2, String diemMon3, String diemUuTien, String tongDiem,
			String ngheNghiepTruocKhiVaoTruong, String thanhPhanGiaDinh, String thiTHPTNgay, String diaChiNhanThu,
			String emailPhuHuynh, String tenNganhTrungTuyen, String daKhaiPhieuQuanLySinhVien, String daNhapHoc,
			String maChuyenNganh1, String maChuyenNganh2, Lop lop, String ghiChu, String moTa, Date thoiGianCapNhat) {
		super();
	...
	public String toString() {
		return "SinhVien [maSinhVien=" + maSinhVien + ", ten=" + ten + ", hoDem=" + hoDem + ", hoVaTen=" + hoVaTen
				...
				+ ", diaChiKhiCanBaoTinChoAi=" + diaChiKhiCanBaoTinChoAi + ", soBaoDanh=" + soBaoDanh + ", diemMon1="
