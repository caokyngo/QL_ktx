...
public abstract class TaiKhoan implements Comparable<TaiKhoan> {
	...
	public TaiKhoan(String maDangNhap, String matKhau, String anhDaiDien, Date ngayTao, Date ngayCapNhatMatKhau,
			String cauHoiBiMat, String traLoiCauHoiBiMat, String loaiTaiKhoan, boolean trangThaiHoatDong, String email,
			String hoVaTen, String moTa, String ghiChu, Date thoiGianCapNhat, NhomPhanQuyen nhomPhanQuyen) {
		...
		this.traLoiCauHoiBiMat = traLoiCauHoiBiMat;
	...
	public String getCauHoiBiMat() {
		return cauHoiBiMat;
	}

	public void setCauHoiBiMat(String cauHoiBiMat) {
		this.cauHoiBiMat = cauHoiBiMat;
	}

	public String getTraLoiCauHoiBiMat() {
		return traLoiCauHoiBiMat;
	}

	public void setTraLoiCauHoiBiMat(String traLoiCauHoiBiMat) {
		this.traLoiCauHoiBiMat = traLoiCauHoiBiMat;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((cauHoiBiMat == null) ? 0 : cauHoiBiMat.hashCode());
		...
		result = prime * result + ((traLoiCauHoiBiMat == null) ? 0 : traLoiCauHoiBiMat.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (anhDaiDien == null) {
			...
			return false;
		if (cauHoiBiMat == null) {
			if (other.cauHoiBiMat != null)
				return false;
		} else if (!cauHoiBiMat.equals(other.cauHoiBiMat))
			return false;
		if (email == null) {
			if (other.email != null)
				return false;
		...
		if (thoiGianCapNhat == null) {
			...
			return false;
		if (traLoiCauHoiBiMat == null) {
			if (other.traLoiCauHoiBiMat != null)
				return false;
		} else if (!traLoiCauHoiBiMat.equals(other.traLoiCauHoiBiMat))
			return false;
	...
	public String toString() {
		return "TaiKhoan [maDangNhap=" + maDangNhap + ", matKhau=" + matKhau + ", anhDaiDien=" + anhDaiDien
				+ ", ngayTao=" + ngayTao + ", ngayCapNhatMatKhau=" + ngayCapNhatMatKhau + ", cauHoiBiMat=" + cauHoiBiMat
				+ ", traLoiCauHoiBiMat=" + traLoiCauHoiBiMat + ", loaiTaiKhoan=" + loaiTaiKhoan + ", trangThaiHoatDong="
				+ trangThaiHoatDong + ", email=" + email + ", hoVaTen=" + hoVaTen + ", moTa=" + moTa + ", ghiChu="
				+ ghiChu + ", thoiGianCapNhat=" + thoiGianCapNhat + ", nhomPhanQuyen=" + nhomPhanQuyen + "]";
	}
