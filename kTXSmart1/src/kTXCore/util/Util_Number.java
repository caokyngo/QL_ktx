...
public class Util_Number {
	...
	public static String number2String(long n) {
		String number = n + "";
		String convertedString = new DecimalFormat("#,###").format(Double.parseDouble(number));
		return convertedString;
	}
	...
	public static void main(String[] args) throws ParseException {
		double tongtien = 17550000;
		System.out.println(numberToString(tongtien));
		System.out.println(formatNumberForRead(2500000));
		System.out.println(number2String(10000000.56565));
	}
