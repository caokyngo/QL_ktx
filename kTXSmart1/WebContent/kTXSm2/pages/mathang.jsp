...
<%
	...
	String trangDanhSach = "index.jsp?p=kTXSm2/pages/mathangs.jsp";
	...
	if (taiKhoan != null && taiKhoan instanceof TaiKhoanSinhVien) {
		...
		trangDanhSach = "index.jsp?p=kTXSm2/pages/mathang_sinhviens.jsp";
	}
%>
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: left;">
					<div class="row">
						...
						<%
							if(trangDanhSach == "index.jsp?p=kTXSm2/pages/mathang_sinhviens.jsp"){
						%>
						<div class="col-md-7">
							<%@ include file="../../kTXPartial/processformdv.jsp"%>
						</div>
						<%
							}else if(trangDanhSach == "index.jsp?p=kTXSm2/pages/mathangs.jsp"){
						%>
						<div class="col-md-7">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									<label>Mã mặt hàng</label> <input class="form-control" style="text-align: left;"
										name="maMatHang"
										value="
								...
								<div class="form-group">
									<label>Giá nhập</label> <input class="form-control" defaut="0"
										name="s_giaNhap"
