...
<%@page import="kTXCore.modelDanhMuc.TonGiao"%>
<%@page import="kTXCore.modelDaoDanhMuc.DAO_TonGiao"%>
<%@page import="kTXCore.modelDaoDanhMuc.DAO_DanToc"%>
<%@page import="kTXCore.modelDanhMuc.DanToc"%>
<%@page import="kTXCore.model.SinhVien"%>
<%@page import="kTXCore.modelDao.DAO_NamHoc"%>
<%@page import="kTXCore.model.HocKy"%>
<%@page import="kTXCore.util.Util_Date"%>
<%@page import="kTXCore.model.NamHoc"%>
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label>Họ và tên</label> <input class="form-control"
										name="hoVaTen"
										value="<%=(obj != null && obj.getHoVaTen() != null? obj.getHoVaTen() : "")%>"
										<%=(modeView || modeEdit ? " readonly " : "")%>>
								</div>
							</div>
							<div class="col-lg-4">
